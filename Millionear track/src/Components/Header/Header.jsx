...
//                                       " src={logo} alt="" />
//                 </div>
//                 <div className="min-w-[10%] laptop:w-[60%] laptop:h-14 flex items-center">
//                    <button className=" bg-green-600"  onClick={Togglemenuopen}>
//                     <i class="fa-solid fa-bars text-3xl text-black laptop:hidden"></i>
//                     <p>{num}</p>
//                    </button>
//                    <div className="   laptop:h-full laptop:w-full laptop:ps-14 laptop:pe-14 hidden laptop:flex laptop:justify-between laptop:items-center font-medium text-lg">
    ...
    <>
     <div className="min-h-10 mobile:min-h-10 tablets:min-h-10 laptop:min-h-18 p-3 flex shadow-lg">
        ...
        <div className="min-w-[10%] laptop:w-[60%] laptop:h-14 flex items-center justify-end">
          ...
          <div className={` shadow-xl absolute top-0 right-0 w-[85%] h-[70%] mobile:w-[50%] tablets:w-[35%]  bg-white  z-40 flex flex-col items-center justify-center space-y-4 transform ${menuOpen ? 'translate-x-0 block' : 'translate-x-full none'} transition-transform duration-300 laptop:hidden`}>
